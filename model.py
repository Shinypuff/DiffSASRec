...
class SASRecWithDiffusion(SASRec):
    def __init__(self, user_num, item_num, args):
        ...
        self.item_emb = torch.nn.Embedding(self.item_num + 2, args.hidden_units, padding_idx=0) #last embedding is for masked token
    ...
    def get_loss(self, log_seqs):
        ...
        logits = self.item_emb.weight @ log_feats.transpose(1, 2)  # (batch, num_items, seq_len)
        ...
        token_loss = F.cross_entropy(masked_logits, masked_labels, reduction='none') / p_mask[masked_indices]
